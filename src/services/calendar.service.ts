  ...
  */
  ...
  // See function HebToGreg() for the definition of the month numbers.
   GregToHeb(dGreg) {
    ...
    let nMonthLen
    let bWhile
    let d1900:any = new Date(1900, 0, 1)
  ...
  // Here are a few support functions for the sample web page
   ...
   FormatDateH(cDate) {
    ...
    switch (Number(aDate[0])) {
      ...
      case 6:
        ...
        break
      case 7:
        cFormatDate = (this.IsLeapYear(Number(aDate[2])) ? "Adar B" : "Adar")
        break
      case 8:
        cFormatDate = "Nisan"
        break
   ...
   H2G(nYearH, nMonthH, nDateH) {
    nYearH  = Number(nYearH)
    nMonthH = Number(nMonthH)
    nDateH  = Number(nDateH)
   
    //document.write(this.FormatDateH(nMonthH + "/" + nDateH + "/" + nYearH) + " -> ")
    //document.write(this.FormatDate(this.HebToGreg(nYearH, nMonthH, nDateH)))
    //document.write("<p>")
    return this.FormatDateH(nMonthH + "/" + nDateH + "/" + nYearH) + " > " + this.FormatDate(this.HebToGreg(nYearH, nMonthH, nDateH));
  }
   ...
   G2H(nYearG, nMonthG, nDateG) {
    ...
    return this.FormatDate(dGreg) + " -> " + this.FormatDateH(this.GregToHeb(dGreg));
  ...
  //Get year in Hebrew
   G2HY(nYearG, nMonthG, nDateG) {
    ...
    return parseInt(this.FormatDateH(this.GregToHeb(dGreg)).split(',')[1]);
